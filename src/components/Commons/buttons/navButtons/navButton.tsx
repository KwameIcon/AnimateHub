            ...
            <div className="lg:hidden">
                ...
                {isMenu && <ul className="absolute top-0 left-0 w-screen h-screen overflow-y-scroll scrollbar-none bg-black/30 text-black animate-slideInLeft" ref={containerRef}>
                    ...
                    <div className="absolute top-0 left-0 w-3/4 h-full bg-white text-black overflow-y-auto scrollbar-none" ref={menuContainerRef}>
                        ...
                        <li className={`${currentSubMenu.about ? 'text-customRed' : ''} w-full h-12 border-b flex items-center justify-between pl-4 capitalize cursor-pointer hover:duration-75 font-semibold py-4`} onClick={() => {handleCurrentSubMenuDisplay('about'); navigate('/about')}} >
                            <span>About</span>
                        </li>
                        ...
                        <li className={` transition-[max-height] duration-300 ease-in-out capitalize cursor-pointer w-full ${currentSubMenu.serviceSub ? 'max-h-[500px]' : 'max-h-12'} font-bold py-4 px-2 flex flex-col items-start justify-center space-x-1 relative border-b`} onClick={() => handleCurrentSubMenuDisplay('serviceSub')}>
                            ...
                            <div className="w-full overflow-hidden h-auto top-14 -left-1 pl-5">
                                <MiniDropDownCard className="bg-transparent">
                                    <li className="py-2 px-1 rounded hover:bg-customRed hover:text-white"   onClick={() => navigate('/service')}>Service List</li>
                                    <hr />
                                    <li className="py-2 px-1 rounded hover:bg-customRed hover:text-white"   onClick={() => navigate('/service/single')}>Service Single</li>
                                </MiniDropDownCard>
                            </div>
                        </li>
                        ...
                        <li className={` transition-[max-height] duration-300 ease-in-out capitalize cursor-pointer w-full ${currentSubMenu.projectsSub ? 'max-h-[500px]' : 'max-h-12'} font-bold py-4 px-2 flex flex-col items-start justify-center space-x-1 relative border-b`} onClick={() => handleCurrentSubMenuDisplay('projectsSub')}>
                            ...
                            <div className="overflow-hidden h-auto top-14 -left-1 pl-5">
                                <MiniDropDownCard className="bg-transparent">
                                    <li className="py-2 px-1 hover:bg-customRed hover:text-white"  onClick={() => navigate('/projects')}>Project List</li>
                                    <hr />
                                    <li className="py-2 px-1 hover:bg-customRed hover:text-white"  onClick={() => navigate('/projects/single')}>Project Single</li>
                                </MiniDropDownCard>
                            </div>
                        </li>
            ...
            <div className="hidden lg:flex md:items-center md:justify-center md:space-x-2 md:dark:from-ebony/75">
                <ul className="md:flex md:items-center md:justify-center md:space-x-2">
                    ...
                    <li className="capitalize cursor-pointer font-semibold py-4 px-2 flex flex-col items-start justify-center space-x-1 relative group">
                        ...
                        <div className="overflow-hidden h-auto absolute top-14 -left-1">
                            <MiniDropDownCard className="hidden group-hover:flex">
                                <li className="py-2 px-1 hover:bg-customRed text-white/80" onClick={() => navigate('/service')}>Service List</li>
                                <div className="w-full h-thinHeight bg-white/10" />
                                <li className="py-2 px-1 hover:bg-customRed text-white/80" onClick={() => navigate('/service/single')}>Service Single</li>
                            </MiniDropDownCard>
                        </div>
                    </li>
                    ...
                    <li className="capitalize cursor-pointer font-semibold py-4 px-2 flex flex-col items-start justify-center space-x-1 relative group">
                        ...
                        <div className="overflow-hidden h-auto absolute top-14 -left-1">
                            <MiniDropDownCard className="hidden group-hover:flex">
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"   onClick={() => navigate('/projects')}>Project List</li>
                                <div className="w-full h-thinHeight bg-white/10" />
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"   onClick={() => navigate('/projects/single')}>Project Single</li>
                            </MiniDropDownCard>
                        </div>
                    </li>
                    ...
                    <li className="capitalize cursor-pointer font-semibold py-4 px-2 flex flex-col items-start justify-center space-x-1 relative group">
                        ...
                        <div className="overflow-hidden h-auto absolute top-14 -left-1">
                            <MiniDropDownCard className="hidden group-hover:flex">
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"  onClick={() => navigate('/testimonials')}>Testimonial</li>
                                <div className="w-full h-thinHeight bg-white/10" />
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"  onClick={() => navigate('/teams')}>Team</li>
                                <div className="w-full h-thinHeight bg-white/10" />
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"  onClick={() => navigate('/pricing')}>Pricing</li>
                                <div className="w-full h-thinHeight bg-white/10" />
                                <li className="py-2 px-1 hover:bg-customRed text-white/80"  onClick={() => navigate('/faqs')}>FAQ</li>
                            </MiniDropDownCard>
                        </div>
                    </li>
