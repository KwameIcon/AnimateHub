...
const PortfolioCard: React.FC<PortfolioCardProp> = ({className, Image, children, dataAos}) => {
    ...
    return(
        <div className={`w-72 m-auto md:w-[22rem] lg:w-56 xl:w-[20rem] h-[25rem] md:h-[29rem] lg:h-[20rem] xl:h-[29rem] overflow-hidden rounded relative group ${className}`} data-aos ={dataAos}>
