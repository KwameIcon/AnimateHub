        ...
        <div className='w-full h-full'>
            ...
            <div className=' relative z-20 top-32 md:top-1/4 left-auto w-11/12 lg:w-7/12 h-3/4 m-auto flex items-center justify-center overflow-hidden '>
                <div className='flex flex-col items-center justify-center animate-slideInSlow'>
                    <p className=' text-4xl leading-relaxed md:text-6xl md:leading-relaxed xl:text-7xl text-center font-semibold uppercase lg:leading-relaxed xl:leading-relaxed font-Oswald lg:tracking-wider '>empowering your digital future</p>
                    <div className='mt-12'>
                        <PrimaryButton className='relative'>
                            ...
                            <div className='h-full flex items-center justify-center'>
                                ...
                                <span className=' -mt-halfMargin -ml-2 text-white'>
                                    {'>'}
                                </span>
                            </div>
                        </PrimaryButton>
...
export const SecondSlide = () => {
    ...
    return(
        <div className='w-full h-full'>
            ...
            <div className=' relative z-20 top-1/4 left-auto w-8/12 xl:w-10/12 h-3/4 m-auto flex items-center justify-center overflow-hidden '>
                <div className='flex flex-col items-center justify-center animate-slideInSlow'>
                    <p className='text-6xl xl:text-7xl text-center uppercase font-semibold tracking-wider xl:tracking-wider lg:leading-relaxed xl:leading-relaxed font-Oswald'>Shaping tomorrow, one innovation at a time</p>
                    <div className='mt-12'>
                        <PrimaryButton className='relative'>
                            <span className='text-sm md:text-lg'>discover more</span>
                            <div className='h-full flex items-center justify-center'>
...
export const ThirdSlide = () => {
    ...
    return(
        <div className='w-full h-full'>
            ...
            <div className=' relative z-20 top-1/4 left-auto w-8/12 xl:w-10/12 h-3/4 m-auto flex items-center justify-center overflow-hidden '>
                <div className='flex flex-col items-center justify-center animate-slideInSlow'>
                    <p className='text-6xl xl:text-7xl text-center font-semibold uppercase leading-relaxed xl:leading-relaxed font-Oswald tracking-wider xl:tracking-wider'>Unlocking limitless possibilities, today</p>
                    <div className='mt-12'>
                        <PrimaryButton className='relative'>
                            <span className='text-sm md:text-lg'>discover more</span>
                            <div className='h-full flex items-center justify-center'>
