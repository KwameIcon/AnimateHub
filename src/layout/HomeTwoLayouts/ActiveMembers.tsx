                            ...
                            <p className='capitalize text-lg text-black/60 dark:text-white/60'>{member.title}</p>
                                <div className='flex items-center justify-center my-3 relative group'>
                                    <ul className={` lg:absolute lg:-z-50 lg:right-12 flex lg:hidden group-hover:flex items-center justify-center gap-5 `} >
                                        <li className='w-12 h-12 lg:w-10 lg:h-10 flex items-center justify-center text-xl rounded-full border border-black/30 dark:border-white/30 transition-all duration-300 ease-linear hover:bg-customRed animate-slideFromBottom1 '><FontAwesomeIcon icon={faFacebookF} /></li>
                                        <li className='w-12 h-12 lg:w-10 lg:h-10 flex items-center justify-center text-xl rounded-full border border-black/30 dark:border-white/30 transition-all duration-300 ease-linear hover:bg-customRed animate-slideFromBottom2 '><FontAwesomeIcon icon={faTwitter} /></li>
                                        <li className='w-12 h-12 lg:w-10 lg:h-10 flex items-center justify-center text-xl rounded-full border border-black/30 dark:border-white/30 transition-all duration-300 ease-linear hover:bg-customRed animate-slideFromBottom3 '><FontAwesomeIcon icon={faLinkedin} /></li>
                                        <li className='w-12 h-12 lg:w-10 lg:h-10 flex items-center justify-center text-xl rounded-full border border-black/30 dark:border-white/30 transition-all duration-300 ease-linear hover:bg-customRed animate-slideFromBottom4 '><FontAwesomeIcon icon={faPinterest} /></li>
                                    </ul>
