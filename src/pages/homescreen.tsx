    ...
    return(
        <section className="w-full h-auto overflow-hidden">
            ...
            <div className="w-[97%] m-auto h-auto flex flex-col items-center justify-center my-10 mt-20" >
                <h3 className="uppercase text-customRed font-bold tracking-widest my-5" >latest portfolio</h3>
                <h1 className="w-[90%] lg:w-1/2 m-auto text-3xl md:text-5xl font-Oswald font-bold text-center leading-[3.5rem]" >Where Innovation Meets IT Excellence</h1>
                {/* cards */}
            ...
            <div className="w-[95%] extraExtraLarge:w-3/5 mx-auto my-10 mt-32 flex flex-wrap items-center justify-center md:gap-10 lg:gap-1  lg:justify-between">
                <Card className="!w-[19rem] !h-40 relative !justify-center space-y-2 dark:bg-graphiteBlack bg-gray-100 shadow">
