    ...
    return(
        <section className="w-screen min-h-screen extraExtraLarge:w-3/5 m-auto overflow-hidden">
            ...
            <div className="w-11/12 h-auto lg:w-[97%] xl:w-11/12 m-auto my-10 lg:grid grid-cols-2 place-items-center" data-aos="fade-up" data-aos-delay="0">
                <div className="w-full grid grid-cols-1 gap-5 font-sans">
                ...
                <div className="w-full md:w-11/12 m-auto h-[25rem] md:h-[30rem] my-10 relative flex items-center justify-center">
                    <div className="absolute z-[1] inset-0 bg-customRed rounded rotate-3 w-full h-full"/>
